...
Bem-vindo ao Laby, um jogo de labirinto feito com a linguagem Python utilizando a biblioteca Pygame. O objetivo do jogo é escapar do labirinto tendo em mente que ele está repleto de caminhos sem saída. 
